...
|userauth_infos|用户授权APP信息储存表|
|logged_infos|用户已登录信息储存表(主站Token储存表)|
|oauth_infos|OAuth信息储存表(第三方APP Token储存表)|
|notification_infos|提醒消息信息储存表|
...
|relatedapps|TEXT|用户可以管理的APPID|gzcompress(Original JSON)|["appid1","appid2"]|
|avatar|CHAR(32)|用户头像md5|md5(头像数据)|如果是默认头像, 写default|
