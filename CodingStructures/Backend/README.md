...
|验证码action_id|名称|方式|注释|
|-|-|-|-|
|10001|邮箱验证|EMAIL|-|
|10002|手机验证|SMS \| PHONE_CALL|-|
|20001|密码修改申请验证|ANY_METHOD|-|
|20002|修改邮箱验证|ANY_METHOD|-|
|20003|修改手机验证|ANY_METHOD|-|
|30001|管理员操作验证|ANY_METHOD|-|
|90001|第三方APP重要操作验证|ANY_METHOD|-|
|90002|第三方APP删除内容验证|ANY_METHOD|-|
