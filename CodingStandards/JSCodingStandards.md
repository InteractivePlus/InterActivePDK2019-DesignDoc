...
注意: 本文档来源于百度FEX Team, 本文档对原文档做出了部分删改, 原版本信息请参照[Github链接](https://github.com/fex-team/styleguide/blob/master/javascript.md)   


## 1 前言

JavaScript在网页中一直有着广泛的应用，特别是在浏览器端的行为管理。本文档的目标是使JavaScript代码风格保持一致，容易被理解和被维护。
...
##### [建议] 二元运算符两侧有一个空格，一元运算符与操作对象之间没有空格。
